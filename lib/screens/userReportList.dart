...
import 'package:docotg/screens/ReportPage.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Text(widget.snap['fname'].toString().toUpperCase(),style: TextStyle(fontSize: 21,fontWeight: FontWeight.bold),),),
              SizedBox(height: height*0.02,),
